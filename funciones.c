...
// Entradas: Caracter a comparar, arreglo de caracteres a comparar, tamaño del
// arreglo Salidas: 1 si el caracter está en el arreglo, 0 si no Descripcion:
// Función que compara un caracter con un arreglo de caracteres
